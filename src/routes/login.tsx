  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-bg px-6 text-fg">
      <div className="w-full max-w-sm">
        <p className="text-xs font-medium tracking-[0.22em] text-muted uppercase">Gravity Switch</p>
        <h1 className="font-display mt-3 text-3xl tracking-tight">Přihlášení</h1>
        <p className="mt-2 text-sm leading-relaxed text-muted">
          Účet je volitelný — hra běží i bez něj. Rekordy se ukládají v tomto prohlížeči.
        </p>
